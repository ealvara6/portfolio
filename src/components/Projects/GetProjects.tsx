  ...
  const data = [
    {
      ...
      desc: 'This website is a project within the Odin Project. This website allowed me to strengthen my concepts of express and routing. This website takes in user input within the forms page and once submitted, adds the new form information into the posts table which is displayed on the home page.',
      tech: ['Express', 'Tailwindcss', 'EJS', 'PostgresSQL'],
